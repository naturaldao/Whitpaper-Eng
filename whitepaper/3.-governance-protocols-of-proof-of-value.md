...
* The protocol also includes rules for upgrading the smart common. Proxy Pattern is a suicide way for any smart common, this means any dApp can not be modified once deployed! You have to deploy another one and register it as a new version of your smart common.
