...
> SC0 v0.1
>
> Using a dApp to Mint a DAO implies that the dApp accepts this protocol as its sole protocol and acknowledges the anonymity of all its owners and managers (referred to as members of the DAO).
>
> 1. No Copyright\
