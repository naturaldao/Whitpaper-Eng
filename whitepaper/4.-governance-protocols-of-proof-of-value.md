...
## Protocol of Valuation Token's Supply**(Hayek Convention Part 1)** <a href="#circulation-token-protocol" id="circulation-token-protocol"></a>

Any DAO can issue its exclusive valuation token. This token is facilitated to grow its economic ecosystem and pave the way for the DAO's long term development.
