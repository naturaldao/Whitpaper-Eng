...
> SP0 v0.1
>
> Using a dApp Mint DAO implies that the dApp accepts the SP0 protocol as its sole protocol and acknowledges the anonymity of all its owners and managers (referred to as members of the DAO).
>
> 1. No Copyright Anonymity signifies that the dApp developed under it contributes entirely to the public domain, becoming a public resource. Apart from enjoying rewards brought about by PoV consensus, it relinquishes all other rights, including any related and adjacent rights.
> 2. No Liability Anonymity implies that members of the DAO are not providing any form of guarantee for their dApp and its exclusive valuation tokens. They do not assume any joint liability.
>
> When using or invoking this dApp, or investing in the DAO's exclusive valuation tokens, no one may imply endorsement from any member of this DAO for their actions.
